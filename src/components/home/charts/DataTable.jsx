...
export default function DataTable(props) {
      ...
      if (props.timeState === 'Rapid') {
        return data.map((value, index) => {
          return {
            ...
            gamesPlayed: data[index].rapidGames,
            ...
            winrate: (data[index].rapidWins / data[index].rapidGames).toFixed(2),
          };
        });
        ...
        return data.map((value, index) => {
          return {
            id: data[index].id,
            openings: data[index].name,
            gamesPlayed: data[index].blitzGames,
            ...
            winrate: (data[index].blitzWins / data[index].blitzGames).toFixed(2),
          };
        });
        ...
        return data.map((value, index) => {
          return {
            id: data[index].id,
            openings: data[index].name,
            gamesPlayed: data[index].bulletGames,
            ...
            winrate: (data[index].bulletWins / data[index].bulletGames).toFixed(2),
          };
        });
        ...
        return data.map((value, index) => {
          return {
            id: data[index].id,
            openings: data[index].name,
            gamesPlayed: data[index].dailyGames,
            ...
            winrate: (data[index].dailyWins / data[index].dailyGames).toFixed(2),
          };
        });
      } else {
        return data.map((value, index) => {
  ...
  console.log(rows(), 'WHAHHHHH DONT YEWWW WERK');
